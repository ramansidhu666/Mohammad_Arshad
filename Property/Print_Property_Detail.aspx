   ...
   <style type="text/css">
    ...
    <script type="text/javascript">
        ...
        function PrintDiv() {
            ...
            sb.append('<h2 style="color: white; margin-bottom: 0px;">Muhammad Arshad</h2>');
            sb.append('<p style="margin-top: 0px;">Sales Representative</p>');
            sb.append('<p style="font-weight: bold;">E-Mail:<span style="font-weight: normal; margin: 0 0px 0 6px;">marshad20@hotmail.com</span></p>');
            sb.append(' <p style="font-weight: bold;">Phone:<span style="font-weight: normal; margin: 0 0px 0 6px;">416-826-1777</span></p></div>');
            ...
            <div style="float: left; width: 100%; background: white; border-radius: 6px;">
                ...
                <div style="float: left; width: 100%; background: #5a6d21; margin-bottom: 12px;">
                    ...
                    <div style="float: left; width: 30%; margin-top: 20px;">
                        <h2 style="color: white; margin-bottom: 0px;">Muhammad Arshad</h2>
                        <p style="margin-top: 0px;">Sales Representative</p>
                        <p style="font-weight: bold;">E-Mail:<span style="font-weight: normal; margin: 0 0px 0 6px;">marshad20@hotmail.com</span></p>
                        <p style="font-weight: bold;">Phone:<span style="font-weight: normal; margin: 0 0px 0 6px;">416-826-1777</span></p>
                    </div>
